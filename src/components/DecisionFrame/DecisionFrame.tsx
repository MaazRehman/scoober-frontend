...
const DecisionFrame: React.FC<DecisionFrameProps> = ({ selectedRoom }) => {
    ...
    const { setWaitingForSecondUser, setWaitingForSecondUserToRespond, setDisabled } = usePresentationLogic();
    ...
    return (
        ...
        <div className="overlay">
            <div className="decision-frame">
                <img src={isWon ? "win.png" : "lose.png"} alt={isWon ? "You won" : "You lose"}/>
