...
describe('<Sidebar />', () => {
    beforeEach(() => {
        ...
        (useSuccessNotification as jest.Mock).mockReturnValue({
            ...
            contextHolder: <div data-testid="mock-context-holder">Mock Context Holder</div>,
        });
    ...
    it('should call handleJoinRoom when room item is clicked', () => {
        ...
        expect(useUserInfo().setSelectedRoom).toHaveBeenCalledWith('Room Amsterdam');
        expect(usePresentationLogic().setWaitingForSecondUser).toHaveBeenCalledWith(true);
    });
